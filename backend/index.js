...
const serviceAccount = require("./test-chat-8b138-firebase-adminsdk-nq0gc-4889c55ed5.json");/*download your own service account key from firebase*/
const client = algoliasearch("XS6RQO7ASC", "308530b9a4200609d85a4722f489be20"); /*use your own keys*/
...
//   credential: admin.credential.cert(serviceAccount)
// });
//	,databaseURL: "https://test-chat.firebaseio.com"
